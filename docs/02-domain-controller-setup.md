...
![AD DS installation confirmation](../images/02-01-ad-ds-install-confirmation.png)
...
![Domain Controller options](../images/02-02-dc-options.png)
...
![Prerequisites check](../images/02-03-dc-prerequisites-check.png)
...
![Review options](../images/02-04-dc-review-options.png)
